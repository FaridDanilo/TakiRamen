...
<head>
    ...
    <title>Kurume Ramen | Takiramen</title>
...
<body class="ramen-detail">
    ...
    <main class="ramen__showcase">
        ...
        <div class="ramen__photo">
            <img src="../assets/img/ramens/kurume.jpg" alt="Kurume Ramen">
        </div>

        <!-- Ramen content -->
        <section class="ramen__details">
            <h2>Kurume Ramen</h2>
            <p class="ramen__quote">「久留米ラーメン — The origin of modern tonkotsu, intense and full of history.」</p>

            <p class="ramen__description">
                Kurume Ramen is the root of modern tonkotsu ramen. Its thick broth is prepared with pork bones simmered for more than 12 hours, resulting in an intense and cloudy flavor.
            </p>
            ...
            <div class="ramen__grid">
                <div class="ramen__block">
                    ...
                    <ul>
                        ...
                        <li>Thin noodles</li>
                        <li>Chashu pork, fried garlic and scallions</li>
                ...
                <div class="ramen__block">
                    ...
                    <h3>Flavor</h3>
                    <p>Deep, salty and with smoky nuances.</p>
                </div>

                <div class="ramen__block">
                    <i class="fa-solid fa-fire-flame-curved"></i>
                    <h3>Scent</h3>
                    <p>Rich, intense and meaty.</p>
                </div>

                <div class="ramen__block">
                    <i class="fa-solid fa-water"></i>
                    <h3>Texture</h3>
                    <p>Thick and silky, with a heavy, comforting body.</p>
                </div>
            </div>
        </section>
